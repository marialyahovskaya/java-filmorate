DROP TABLE USERS, FILMS, GENRES, MPA_RATINGS, LIKES, FRIENDSHIPS, FILM_GENRES CASCADE;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FILMS;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MPA_RATINGS;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FILM_GENRES;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FRIENDSHIPS;
...
INSERT INTO GENRES(name) VALUES ('Comedy'), ('Drama'), ('Cartoon'), ('Триллер'), ('Документальный'), ('Боевик');